...
import com.yas.backend.domain.invitation.service.InvitationCommandService;
...
public class InvitationCommandController {
    ...
    @PatchMapping(value = "/team/invitaion/{invitationId}/status")
    ...
    @DeleteMapping(value = "/team/invitation/{invitationId}/status")
    public void deleteInvitation(@PathVariable("invitationId") Long invitationId) {
        invitationCommandService.remove(invitationId);
    }
}
